...
Daily Sales Volume – Analyze how many products were sold per day.

Order Flow – Visualize the flow and status of incoming orders.

Business KPIs – Track performance metrics like revenue, profit %, average order value, and sales growth.

2. Tech Stack
Component	Tool	Purpose
Dashboard	Power BI Desktop	Report creation and visualization
Data Transformation	Python via Power Query	Data cleaning & preprocessing
Calculations	DAX (Power BI)	Custom measures and KPIs
...
Python with required libraries (e.g., pandas) if you're modifying transformation steps
